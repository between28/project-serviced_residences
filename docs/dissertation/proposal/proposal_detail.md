...
### 9.1 Ethics and Data Governance

- Analysis outputs will be reported at non-identifiable aggregation levels.
- Direct identifiers are only used for controlled linkage and are excluded from analytic exports.
- Data storage and access controls will be documented as part of the dissertation appendix.

### 9.2 Reproducibility

- The full pipeline will be script-first (`src/` stages), not notebook-dependent.
- Variable construction and policy coding will be versioned in `docs/dissertation/data/` and `docs/dissertation/policy/`.
- Main and robustness outputs will be regenerated from clean inputs before final submission.
